...
static int fp_register_proc_fs(struct fp_data *fp_data)
{
    ...
    fp_id_retry = 0;
#if CONFIG_OPPO_FINGERPRINT_PROJCT == 19631
    fp_data->fp_id0 = 1;
    fp_data->fp_id1 = -1;
    fp_data->fp_id2 = -1;
#elif CONFIG_OPPO_FINGERPRINT_PROJCT == 19633 || CONFIG_OPPO_FINGERPRINT_PROJCT == 19632 || CONFIG_OPPO_FINGERPRINT_PROJCT == 19637 || CONFIG_OPPO_FINGERPRINT_PROJCT == 19638 || CONFIG_OPPO_FINGERPRINT_PROJCT == 19743 || CONFIG_OPPO_FINGERPRINT_PROJCT == 19745
